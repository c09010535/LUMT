	...
	icntl, int_t *info)
{
	...
	mc64bd_(int_t *n, int_t *ne, int_t *ip, int_t *irn, double *a,
		int_t *iperm, int_t *num, int_t *jperm, 
	...
	mc64sd_(int_t *n, int_t *ne, int_t *ip, int_t *irn, double *a,
		int_t *iperm, int_t *numx, int_t *w, int_t *len, int_t *lenl,
		int_t *lenh, int_t *fc, int_t *iw, int_t *iw4),
	mc64wd_(int_t *n, int_t *ne, int_t *ip, int_t *irn, double *a,
		int_t *iperm, int_t *num, int_t *jperm, int_t *out,
...
/* L3: */
	...
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
        //printf("64Row[%d] (%d,%d):", j, ip[j], ip[j+1]);
	    i__2 = ip[j + 1] - 1;
	    for (k = ip[j]; k <= i__2; ++k) {
		i__ = irn[k];
        //printf(" %d", (int)i__);
